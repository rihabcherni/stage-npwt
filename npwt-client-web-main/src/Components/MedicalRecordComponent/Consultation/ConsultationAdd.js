...
import { Button, FormHelperText, OutlinedInput, TextField, FormControl, InputLabel, Select, MenuItem, Container, Box} from "@mui/material";
...
export default function ConsultationAdd({patientId,handleCloseAdd}) {
...
onChange={handleChangeconsultationInfo} placeholder="Commentaire" 
        ...
        <div className='text-center mt-2'>
            <Button variant='outlined' sx={{ textTransform:"capitalize" }} 
              onClick={handleCloseAdd}>Retour</Button>
