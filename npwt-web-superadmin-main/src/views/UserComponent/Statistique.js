...
const Statistique = () => {
  ...
  const iconColors = ["bg-yellow", "bg-blue", "bg-green", "bg-red", "bg-purple"];
  const iconName = ["fa-users", "fa-user-nurse","fa-user-doctor", "fa-user-tie", "fa-user-check"];

  useEffect(() => {
    (async function fetchCard() {
      try {
        const dataCard = await fetch(`${process.env.REACT_APP_BACKEND_URL}/statistique/countUsers`);
